...
async def generate_prompt(request: Request, scene: str = Form(...)):
    max_length = 4000 # Set your desired limit
    ...
    try:
        ...
        Analyze the following book scene description and create a detailed text prompt that will be used to generate a realistic image within 200 - 500 words.
        ...
        **Output:**
        Generate a single paragraph that describes the scene in detail, suitable for a text-to-image model.
        """
